...
export const Home = () => {
	...
	return (
		<div id="home" style={{ mt: 3, display: 'flex', flexDirection: 'column' }}>
			<Typography
				variant="h3"
				sx={{ textAlign: 'center', color: '#cccccc', mb: 3 }}
			>
				{`<dotGuide />`}
			</Typography>
			<Box sx={{ display: 'flex', justifyContent: 'center' }}>
				<Typography sx={{ width: '80%', color: '#cccccc' }}>
					Tool for software developers to standardized guides. Developers are
					given a template for all the information you might want in a guide. A
					finished guide displays a side-by-side view of code and reference’s
					that explain specific portions of the code block.
				</Typography>
			</Box>
